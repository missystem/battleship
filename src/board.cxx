...
Board::Board(Dimensions dims)
        : dims_(dims)
{
    if (dims_.width < 20 || dims_.height < 20) {
...
bool
Board::good_position_p1(Position pos) const
{
    return 0 <= pos.x && pos.x < 10 &&
           0 <= pos.y && pos.y < 10;
}
bool
Board::good_position_p2(Position pos) const
{
    return 10 <= pos.x && pos.x < 19 &&
           10 <= pos.y && pos.y < 19;
}
