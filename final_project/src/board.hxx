...
public:
    ...
    bool good_attack_position(Position, Player) const;
    ...
    // Player operator[](Position pos, Player) const;
    ...
    ///
    ///  - throws `ge211::Client_logic_error` if `!good_position(pos)`.
    // reference operator[](Position pos, Player);
    ...
    size_t count_player_hits(Player) const;
